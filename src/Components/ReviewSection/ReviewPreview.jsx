...
const ReviewPreview = ({data}) => {
    const { testimonial, avatar, name, rating,titleOfComment,umberOfEmployees,companyName,jobPosition } = data;
    return (
        <div>
      <div className="border border-gray-200 rounded-lg shadow-md hover:shadow-green-400/50  cursor-pointer">
     ...
     <FaQuoteLeft className="text-green-200 w-12 h-12 flex-shrink-0 ml-2" />
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="  position-absolute bottom-0 mb-3 mt-2">
              <Rating
                readonly
